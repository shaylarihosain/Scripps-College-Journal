...
on DetermineCompatibility()
	...
	if AIexists = true and IDexists = true then
		...
		set part1beginning to "Before installing InDesign and Illustrator, update " & osfamily & ". Otherwise, you'll only be able to install old Adobe software, and you won't be able to open design work the rest of your team creates."
